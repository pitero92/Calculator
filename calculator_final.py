...
master = Tk()
display = Entry(master, width=21, justify="right", bg="lightgrey")
...
b_plus = Button(master, text="+", command=lambda: calc.set_op(0),width=5)
b_minus = Button(master, text="-", command=lambda: calc.set_op(1),width=5)
b_multi = Button(master, text="*", command=lambda: calc.set_op(2),width=5)
b_div = Button(master, text="/", command=lambda: calc.set_op(3),width=5)
